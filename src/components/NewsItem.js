...
const NewsItem = (props)=> {
    ...
    return (
      <div className='my-3'>
        ...
        <a href={newsUrl} target='_blank' rel="noreferrer"><img src={imageUrl?imageUrl:imagePlaceholder} onError={(event) => {event.target.src = imagePlaceholder}} className='card-img-top' alt="news" /></a>
